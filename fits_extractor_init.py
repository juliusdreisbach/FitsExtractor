...
ttk.Label(left_frame, text="EXTRACTOR v1.4.1", font=("Arial", 9)).pack(padx=20, pady=5,fill='both', expand=True)
...
button_old = tk.Button(left_frame, text="Run FITS Extractor 1.4.1", command=run_fits_extractor)
